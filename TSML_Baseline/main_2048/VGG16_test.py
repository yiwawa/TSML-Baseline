...
from Model.model_2048.VGG161D import VGG161D  ######## TODO
...
def main():
    ...
    writer = SummaryWriter(log_dir=f'runs/VGG16_2048/{current_time}')    ######## TODO
    ...
    epochs = 50
    save_path = '../result/2048/VGG16_2048.pth'  ######## TODO
    best_acc = 0.0
